...
export const ENGRAVING_SURFACE_CLASS: Record<EngravingShape, string> = {
  ...
  bar: 'w-40 h-80 sm:w-52 sm:h-[460px] rounded-2xl',
  heart: 'w-72 h-72 sm:w-[420px] sm:h-[420px] rounded-[30%]',
  oval: 'w-64 h-80 sm:w-72 sm:h-[440px] rounded-[50%]',
...
/** Width ÷ height — matches the base Tailwind sizes in ENGRAVING_SURFACE_CLASS. */
